...
namespace Planify.Migrations
{
    ...
    [Migration("20250406201643_tarjettapago")]
    partial class tarjettapago
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Planify.Models.Pagos", b =>
                {
                    ...
                    b.Property<string>("ApodoTarjeta")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<double>("agregadoItbis")
                        .HasColumnType("float");
            ...
            modelBuilder.Entity("PagosDetalle", b =>
                {
                    b.HasOne("Planify.Models.Pagos", "Pago")
                        .WithMany("Detalles")
            ...
            modelBuilder.Entity("Planify.Models.Presupuestos", b =>
                {
                    b.HasOne("Planify.Models.Eventos", "Evento")
                        .WithOne("Presupuesto")
                        .HasForeignKey("Planify.Models.Presupuestos", "EventoId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
